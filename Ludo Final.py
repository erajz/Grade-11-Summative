#    Name:  Eraj Zaidi
#    Date:  June 11, 2019
#    File Name:  Ludo Final
#    Description:  Ludo game using pygame and python.
...
def displaymenu(prevscreen):
    ...
    while True:
        ...
        # Gets teh mouse clicks using the getmouseclicks function - Line: 61
...
def playgame(alreadymoved, roll):
    ...
    while True:
        ...
        if rolldisplay == False:
            ...
            if clickx >= 223 and clickx <= 363:
                if clicky >= 223 and clicky <= 363:
